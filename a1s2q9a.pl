...
family(person(bob, armstrong, date(12, october, 1977), works(ntnu, 12000)),
       person(liz, armstrong, date(6, october, 1975), unemployed),
       [person(bob, armstrong, date(6, october, 1999),unemployed),
       person(sam, armstrong, date(8, october, 1988), unemployed)]).
